...
par("mfrow"=c(2,2))
par("mfrow")
plot(df$d3,df$"Global_active_power", type="l", xlab="", ylab="Global Active Power")
plot(df$d3,df$"Voltage", type="l", ylab="Voltage", xlab="datetime")
...
plot(df$d3,df$"Global_reactive_power", type="l", ylab="Global_reactive_power",xlab="datetime")
